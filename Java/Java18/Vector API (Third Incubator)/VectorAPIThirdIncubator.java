...
// % java --enable-native-access=ALL-UNNAMED --add-modules jdk.incubator.vector VectorAPIThirdIncubator.java
// Or
// % javac --add-modules jdk.incubator.vector VectorAPIThirdIncubator.java
// % java --add-modules jdk.incubator.vector VectorAPIThirdIncubator
...
class VectorAPIThirdIncubator {
    ...
    public void print() {
        System.out.println("# 417: Vector API (Third Incubator)");
